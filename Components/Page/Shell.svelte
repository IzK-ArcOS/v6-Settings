...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.taskbar.centered}
  />
</SettingsOption>
<SettingsOption
...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.taskbar.labels}
  />
</SettingsOption>
<SettingsOption
...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.taskbar.accentedStart}
  />
</SettingsOption>
<hr />
<SettingsOption
...
<SettingsOption title="Dock shell" context="Dock the taskbar and action center">
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.taskbar.docked}
  />
</SettingsOption>
<SettingsOption
...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.compactContext}
  />
</SettingsOption>
