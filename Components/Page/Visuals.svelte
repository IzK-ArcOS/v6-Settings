...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.noGlass}
  />
</SettingsOption>
...
<SettingsOption title="Sharp corners" context="Remove all rounded corners">
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.desktop.sharp}
  />
</SettingsOption>
...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.desktop.noCustomCursor}
  />
</SettingsOption>
<hr />
<SettingsOption
...
>
  <input
    type="checkbox"
    class="switch"
    bind:checked={$UserDataStore.sh.taskbar.colored}
  />
</SettingsOption>
